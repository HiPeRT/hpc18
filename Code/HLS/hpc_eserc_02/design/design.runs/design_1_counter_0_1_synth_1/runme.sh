...
HD_PWD='/storage/Documenti/Didattica/hpc/esercitazioni/hpc_eserc_02/design/design.runs/design_1_counter_0_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_counter_0_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_counter_0_1.tcl
