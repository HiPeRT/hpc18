...
localparam
    ...
    ADDR_IMAGE_R_CTRL    = 6'h14,
    ADDR_NEWIMAGE_DATA_0 = 6'h18,
    ADDR_NEWIMAGE_CTRL   = 6'h1c,
    ADDR_FILTER_DATA_0   = 6'h20,
    ADDR_FILTER_CTRL     = 6'h24,
    WRIDLE               = 2'd0,
    WRDATA               = 2'd1,
    WRRESP               = 2'd2,
    WRRESET              = 2'd3,
...
//------------------------Local signal-------------------
    ...
    reg  [31:0]                   int_image_r = 'b0;
    reg  [31:0]                   int_newImage = 'b0;
    ...
    if (ACLK_EN) begin
        if (ar_hs) begin
            ...
            case (raddr)
                ...
                ADDR_NEWIMAGE_DATA_0: begin
                    rdata <= int_newImage[31:0];
                end
...
always @(posedge ACLK) begin
    if (ARESET)
        ...
        if (w_hs && waddr == ADDR_NEWIMAGE_DATA_0)
            int_newImage[31:0] <= (WDATA[31:0] & wmask) | (int_newImage[31:0] & ~wmask);
    end
end
