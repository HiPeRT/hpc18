...
void XConv_Set_image_r(XConv *InstancePtr, u32 Data) {
    Xil_AssertVoid(InstancePtr != NULL);
    Xil_AssertVoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    XConv_WriteReg(InstancePtr->Ctrl_BaseAddress, XCONV_CTRL_ADDR_IMAGE_R_DATA, Data);
}

u32 XConv_Get_image_r(XConv *InstancePtr) {
    u32 Data;

    Xil_AssertNonvoid(InstancePtr != NULL);
    Xil_AssertNonvoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    Data = XConv_ReadReg(InstancePtr->Ctrl_BaseAddress, XCONV_CTRL_ADDR_IMAGE_R_DATA);
    return Data;
}

void XConv_Set_newImage(XConv *InstancePtr, u32 Data) {
    Xil_AssertVoid(InstancePtr != NULL);
    Xil_AssertVoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    XConv_WriteReg(InstancePtr->Ctrl_BaseAddress, XCONV_CTRL_ADDR_NEWIMAGE_DATA, Data);
}

u32 XConv_Get_newImage(XConv *InstancePtr) {
    u32 Data;

    Xil_AssertNonvoid(InstancePtr != NULL);
    Xil_AssertNonvoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    Data = XConv_ReadReg(InstancePtr->Ctrl_BaseAddress, XCONV_CTRL_ADDR_NEWIMAGE_DATA);
    return Data;
}
