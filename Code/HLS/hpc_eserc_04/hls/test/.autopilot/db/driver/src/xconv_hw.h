...
#define XCONV_CTRL_ADDR_IMAGE_R_DATA  0x10
#define XCONV_CTRL_BITS_IMAGE_R_DATA  32
#define XCONV_CTRL_ADDR_NEWIMAGE_DATA 0x18
#define XCONV_CTRL_BITS_NEWIMAGE_DATA 32
#define XCONV_CTRL_ADDR_FILTER_DATA   0x20
