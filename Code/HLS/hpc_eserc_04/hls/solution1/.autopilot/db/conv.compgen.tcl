...
set ID 11
set hasByteEnable 0
set MemName conv_image
set CoreName ap_simcore_mem
set PortList { 2 3 }
set DataWd 8
set AddrRange 230400
set AddrWd 18
...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler conv_mem_m_axi
}
