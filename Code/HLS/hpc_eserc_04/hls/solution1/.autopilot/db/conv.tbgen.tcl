set C_TypeInfoList {{ 
"conv" : [[], { "return": [[], "void"]} , [{"ExternC" : 0}], [ {"image_dram": [[],{ "pointer": "0"}] }, {"filter": [[],{ "pointer":  {"scalar": "float"}}] }, {"filterDim": [[], {"scalar": "int"}] }],[],""], 
"0": [ "uint8_t", {"typedef": [[[],"1"],""]}], 
...
set C_modelArgList {
	...
	{ image_dram int 32 regular {axi_slave 0}  }
	{ filter int 32 regular {axi_slave 0}  }
	{ filterDim int 32 regular {axi_slave 0}  }
}
set C_modelArgMapList {[ 
	{ "Name" : "mem", "interface" : "axi_master", "bitwidth" : 32, "direction" : "READWRITE", "bitSlice":[{"low":0,"up":7,"cElement": [{"cName": "image_dram","cData": "unsigned char","bit_use": { "low": 0,"up": 7},"offset": { "type": "dynamic","port_name": "image_dram","bundle": "AXILiteS"},"direction": "READWRITE","cArray": [{"low" : 0,"up" : 0,"step" : 4}]},{"cName": "filter","cData": "float","bit_use": { "low": 0,"up": 7},"offset": { "type": "dynamic","port_name": "filter","bundle": "AXILiteS"},"direction": "READONLY","cArray": [{"low" : 0,"up" : 0,"step" : 1}]}]},{"low":8,"up":15,"cElement": [{"cName": "image_dram","cData": "unsigned char","bit_use": { "low": 0,"up": 7},"offset": { "type": "dynamic","port_name": "image_dram","bundle": "AXILiteS"},"direction": "READWRITE","cArray": [{"low" : 1,"up" : 0,"step" : 4}]},{"cName": "filter","cData": "float","bit_use": { "low": 8,"up": 15},"offset": { "type": "dynamic","port_name": "filter","bundle": "AXILiteS"},"direction": "READONLY","cArray": [{"low" : 0,"up" : 0,"step" : 1}]}]},{"low":16,"up":23,"cElement": [{"cName": "image_dram","cData": "unsigned char","bit_use": { "low": 0,"up": 7},"offset": { "type": "dynamic","port_name": "image_dram","bundle": "AXILiteS"},"direction": "READWRITE","cArray": [{"low" : 2,"up" : 0,"step" : 4}]},{"cName": "filter","cData": "float","bit_use": { "low": 16,"up": 23},"offset": { "type": "dynamic","port_name": "filter","bundle": "AXILiteS"},"direction": "READONLY","cArray": [{"low" : 0,"up" : 0,"step" : 1}]}]},{"low":24,"up":31,"cElement": [{"cName": "image_dram","cData": "unsigned char","bit_use": { "low": 0,"up": 7},"offset": { "type": "dynamic","port_name": "image_dram","bundle": "AXILiteS"},"direction": "READWRITE","cArray": [{"low" : 3,"up" : 0,"step" : 4}]},{"cName": "filter","cData": "float","bit_use": { "low": 24,"up": 31},"offset": { "type": "dynamic","port_name": "filter","bundle": "AXILiteS"},"direction": "READONLY","cArray": [{"low" : 0,"up" : 0,"step" : 1}]}]}]} , 
 	{ "Name" : "image_dram", "interface" : "axi_slave", "bundle":"ctrl","type":"ap_none","bitwidth" : 32, "direction" : "READONLY", "offset" : {"in":16}, "offset_end" : {"in":23}} , 
 	{ "Name" : "filter", "interface" : "axi_slave", "bundle":"ctrl","type":"ap_none","bitwidth" : 32, "direction" : "READONLY", "offset" : {"in":24}, "offset_end" : {"in":31}} , 
 	{ "Name" : "filterDim", "interface" : "axi_slave", "bundle":"ctrl","type":"ap_none","bitwidth" : 32, "direction" : "READONLY", "bitSlice":[{"low":0,"up":31,"cElement": [{"cName": "filterDim","cData": "int","bit_use": { "low": 0,"up": 31},"cArray": [{"low" : 0,"up" : 0,"step" : 0}]}]}], "offset" : {"in":32}, "offset_end" : {"in":39}} ]}
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1", "2", "3", "4", "5", "6", "7", "8", "9"],
		...
		"Port" : [
			...
			{"Name" : "image_dram", "Type" : "None", "Direction" : "I"},
			{"Name" : "filter", "Type" : "None", "Direction" : "I"},
			{"Name" : "filterDim", "Type" : "None", "Direction" : "I"}]},
	...
	{"ID" : "4", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.newImage_0_U", "Parent" : "0"},
	{"ID" : "5", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.conv_fadd_32ns_32bkb_U1", "Parent" : "0"},
	{"ID" : "6", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.conv_fmul_32ns_32cud_U2", "Parent" : "0"},
	{"ID" : "7", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.conv_sitofp_32ns_dEe_U3", "Parent" : "0"},
	{"ID" : "8", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.conv_fptrunc_64nseOg_U4", "Parent" : "0"},
	{"ID" : "9", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.conv_fpext_32ns_6fYi_U5", "Parent" : "0"}]}


set ArgLastReadFirstWriteLatency {
	conv {
		mem {Type IO LastRead 35 FirstWrite 15}
		image_dram {Type I LastRead 0 FirstWrite -1}
		filter {Type I LastRead 0 FirstWrite -1}
		filterDim {Type I LastRead 0 FirstWrite -1}}}
