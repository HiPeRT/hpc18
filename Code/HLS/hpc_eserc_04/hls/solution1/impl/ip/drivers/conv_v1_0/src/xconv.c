...
void XConv_Set_image_dram(XConv *InstancePtr, u32 Data) {
    Xil_AssertVoid(InstancePtr != NULL);
    Xil_AssertVoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    XConv_WriteReg(InstancePtr->Ctrl_BaseAddress, XCONV_CTRL_ADDR_IMAGE_DRAM_DATA, Data);
}

u32 XConv_Get_image_dram(XConv *InstancePtr) {
    u32 Data;

    Xil_AssertNonvoid(InstancePtr != NULL);
    Xil_AssertNonvoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    Data = XConv_ReadReg(InstancePtr->Ctrl_BaseAddress, XCONV_CTRL_ADDR_IMAGE_DRAM_DATA);
    return Data;
}

void XConv_Set_filter(XConv *InstancePtr, u32 Data) {
    Xil_AssertVoid(InstancePtr != NULL);
    Xil_AssertVoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    XConv_WriteReg(InstancePtr->Ctrl_BaseAddress, XCONV_CTRL_ADDR_FILTER_DATA, Data);
}

u32 XConv_Get_filter(XConv *InstancePtr) {
    u32 Data;

    Xil_AssertNonvoid(InstancePtr != NULL);
    Xil_AssertNonvoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    Data = XConv_ReadReg(InstancePtr->Ctrl_BaseAddress, XCONV_CTRL_ADDR_FILTER_DATA);
    return Data;
}

void XConv_Set_filterDim(XConv *InstancePtr, u32 Data) {
    Xil_AssertVoid(InstancePtr != NULL);
    Xil_AssertVoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    XConv_WriteReg(InstancePtr->Ctrl_BaseAddress, XCONV_CTRL_ADDR_FILTERDIM_DATA, Data);
}

u32 XConv_Get_filterDim(XConv *InstancePtr) {
    u32 Data;

    Xil_AssertNonvoid(InstancePtr != NULL);
    Xil_AssertNonvoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    Data = XConv_ReadReg(InstancePtr->Ctrl_BaseAddress, XCONV_CTRL_ADDR_FILTERDIM_DATA);
    return Data;
}
